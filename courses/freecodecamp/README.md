...
4. Python Certification - /python (not completed yet)
5. Relational Databases Certification - /rel_databases (not started)
6. Back End Development and APIs Certification - /backend_dev_apis (not started)
